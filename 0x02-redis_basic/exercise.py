...
def count_calls(method: Callable) -> Callable:
    """cont how many times the method to count calls is called"""
...
def replay(method: Callable) -> None:
    """Display the history of how many times a method is called"""
...
class Cache:
    ...
    def get(
        ...
        """Reading from redis while retaining the original type"""
